"""
Script para execução massiva de testes do módulo powerlaw.
...
def executa_teste(config):
    ...
    cmd = f"python test_pwl.py {config['execucoes']} {config['vertices']} {config['arquivo']}"
...
def executa_bateria_testes():
    ...
    print("🚀 Iniciando Bateria de Testes Massivos - Power-Law")
    print("=" * 60)
...
def executa_teste_especifico():
    ...
    print("🎯 Teste Específico - Power-Law")
    print("=" * 30)
    
    try:
        execucoes = int(input("Número de execuções por tipo: ") or "5")
        vertices_input = input("Vértices (separados por vírgula): ") or "1000,5000"
...
def main():
    """Menu principal."""
    print("🧪 Sistema de Testes Massivos - Módulo Power-Law")
    print("=" * 50)
